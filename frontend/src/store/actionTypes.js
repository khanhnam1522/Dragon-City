...
const PUBLIC_DRAGONS = {
    FETCH: 'PUBLIC_DRAGONS_FETCH_INFO',
    FETCH_ERROR: 'PUBLIC_DRAGONS_FETCH_INFO_ERROR',
    FETCH_SUCCESS: 'PUBLIC_DRAGONS_FETCH_INFO_SUCCESS'
};  

 
export { GENERATION, DRAGON, ACCOUNT , ACCOUNT_DRAGONS, ACCOUNT_INFO, PUBLIC_DRAGONS};